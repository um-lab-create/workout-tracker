(function () {
  ...
  const FOODS = {
    ...
    raisin: definePer100g({ id: 'raisin', name: 'レーズン', units: { '粒': 0.5, '大さじ': 10, 'g': 1 }, per100g: { energy: 324, protein: 2.7, fat: 0.2, carb: 80.7, fiber: 4.1, K: 740, Ca: 65, Fe: 2.3, vitC: 2, Mg: 31, P: 101, Cu: 0.3, Mn: 0.26, vitB6: 0.2, folate: 5 } }),
    coffee: definePer100g({ id: 'coffee', name: 'コーヒー', units: { '杯': 200, 'ml': 1 }, per100g: { energy: 4, protein: 0.2, carb: 0.7, K: 65, Mg: 6, niacin: 0.8 } }),
    milk: definePer100g({ id: 'milk', name: '牛乳', units: { '杯': 200, 'ml': 1, 'g': 1 }, per100g: { energy: 61, protein: 3.3, fat: 3.8, saturatedFat: 2.3, carb: 4.8, salt: 0.1, Na: 41, K: 150, Ca: 110, Mg: 10, P: 93, Zn: 0.4, vitA: 39, vitD: 0.3, vitB2: 0.15, vitB12: 0.3, pantothenic: 0.55, biotin: 2.0, vitC: 1 } }),
    ...
    oikos: definePer100g({ id: 'oikos', name: 'オイコス', units: { '個': 113, 'g': 1 }, per100g: { energy: 92, protein: 10.1, carb: 12.9, Ca: 130, K: 140, P: 110, vitB2: 0.17, vitB12: 0.5 } }),
    ...
    'chicken-breast': definePer100g({ id: 'chicken-breast', name: '鶏胸肉', units: { '枚': 220, '100g': 100, 'g': 1 }, per100g: { energy: 108, protein: 22.3, fat: 1.5, saturatedFat: 0.4, carb: 0, Na: 40, K: 330, P: 200, Fe: 0.4, Zn: 0.7, Se: 17, niacin: 11.8, vitB6: 0.64, vitB12: 0.2, pantothenic: 1.6 } }),
    ...
    'pork-loin': definePer100g({ id: 'pork-loin', name: '豚ロース', units: { '枚': 120, '100g': 100, 'g': 1 }, per100g: { energy: 263, protein: 19.3, fat: 19.2, saturatedFat: 6.8, carb: 0.2, Na: 46, K: 310, P: 180, Fe: 0.7, Zn: 1.6, vitB1: 0.69, vitB2: 0.17, niacin: 5.9, vitB6: 0.32, vitB12: 0.3 } }),
    ...
    tofu: definePer100g({ id: 'tofu', name: '豆腐', units: { 'パック': 150, '丁': 300, 'g': 1 }, per100g: { energy: 56, protein: 4.9, fat: 3.0, carb: 1.6, fiber: 0.3, Na: 5, K: 140, Ca: 120, Mg: 31, P: 69, Fe: 1.5, Zn: 0.6, Cu: 0.12, Mn: 0.3, vitK: 11, vitB1: 0.04, vitB2: 0.03, vitB6: 0.04, folate: 15 } }),
    ...
    kimchi: definePer100g({ id: 'kimchi', name: 'キムチ', units: { '皿': 50, 'g': 1 }, per100g: { energy: 46, protein: 2.8, fat: 0.5, carb: 8.2, fiber: 2.7, salt: 2.2, Na: 870, K: 340, Ca: 45, Mg: 16, P: 37, Fe: 0.6, vitA: 24, vitK: 35, vitB1: 0.03, vitB2: 0.06, vitB6: 0.08, folate: 35, vitC: 18 } }),
    ...
    pasta: definePer100g({ id: 'pasta', name: 'パスタ', units: { '皿': 250, 'g': 1 }, per100g: { energy: 150, protein: 5.2, fat: 0.9, carb: 30.3, fiber: 1.8, salt: 0.1, Na: 2, K: 44, Ca: 12, Mg: 18, P: 63, Fe: 0.6, Zn: 0.5, vitB1: 0.05, vitB2: 0.02, niacin: 0.6, folate: 12 } }),
    udon: definePer100g({ id: 'udon', name: 'うどん', units: { '玉': 200, 'g': 1 }, per100g: { energy: 105, protein: 2.6, fat: 0.4, carb: 21.6, fiber: 1.3, salt: 0.2, Na: 90, K: 8, Ca: 12, Mg: 7, P: 23, Fe: 0.3, vitB1: 0.02, vitB2: 0.01 } }),
    ...
    'chicken-breast-mince': definePer100g({ id: 'chicken-breast-mince', name: '鶏むねひき肉', source: '八訂(むね相当)', units: { '100g': 100, 'g': 1 }, per100g: { energy: 120, protein: 19.0, fat: 4.5, saturatedFat: 1.2, carb: 0, Na: 55, K: 320, P: 190, Fe: 0.5, Zn: 0.8, Se: 17, niacin: 9.0, vitB6: 0.5, vitB12: 0.2, pantothenic: 1.5 } }),
    'chicken-thigh-mince': definePer100g({ id: 'chicken-thigh-mince', name: '鶏ももひき肉', source: '八訂(鶏ひき肉)', units: { '100g': 100, 'g': 1 }, per100g: { energy: 171, protein: 17.5, fat: 12.0, saturatedFat: 3.3, carb: 0, Na: 55, K: 250, P: 110, Fe: 0.8, Zn: 1.1, vitA: 37, niacin: 5.5, vitB6: 0.35, vitB12: 0.3, pantothenic: 1.1 } }),
    'pork-belly': definePer100g({ id: 'pork-belly', name: '豚バラ', source: '八訂', units: { '100g': 100, 'g': 1 }, per100g: { energy: 366, protein: 14.4, fat: 35.4, saturatedFat: 14.6, carb: 0.1, Na: 50, K: 240, P: 130, Fe: 0.6, Zn: 1.8, vitB1: 0.51, vitB2: 0.13, niacin: 4.7, vitB6: 0.22, vitB12: 0.5 } }),
    ham: definePer100g({ id: 'ham', name: 'ロースハム', source: '八訂・要監査', units: { '枚': 20, 'g': 1 }, per100g: { energy: 196, protein: 18.6, fat: 14.5, saturatedFat: 5.3, carb: 1.3, salt: 2.5, Na: 1000, K: 290, Ca: 4, P: 340, Fe: 0.5, Zn: 1.6, vitB1: 0.70, vitB2: 0.12, niacin: 6.5, vitB6: 0.28, vitB12: 0.5 } }),
