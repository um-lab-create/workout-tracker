(function () {
  ...
  const FOODS = {
    ...
    'prod-meiji-r1-drink-112': definePerUnit({ id: 'prod-meiji-r1-drink-112', name: '明治プロビオヨーグルトR-1 ドリンクタイプ 112g', source: 'ラベル近似(2026-06登録・要確認)', coverage: 'label-partial', unitLabel: '本', perUnit: { energy: 76, protein: 3.6, fat: 0.67, carb: 13.9, salt: 0.12, Ca: 129 } }),
    ...
    'bento-oyakodon-20260610': definePerUnit({ id: 'bento-oyakodon-20260610', name: '親子丼弁当(自作・7等分)', source: '実材料全量+標準調味量(醤油大さじ4/みりん大さじ4/酒大さじ4/塩小さじ1/2/味の素2g)を7等分', coverage: 'recipe-standard-seasoning', unitLabel: '食', perUnit: { energy: 772, protein: 45.5, fat: 22.3, saturatedFat: 7.3, carb: 93.0, fiber: 4.9, salt: 3.5, K: 1048, Ca: 244, Mg: 99, Fe: 3.2, vitC: 52, folate: 129, vitD: 1.3 } }),
